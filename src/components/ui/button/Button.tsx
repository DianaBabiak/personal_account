...
export const Button = ({ children, isFullWidth, className = "", isLeftIcon = false, withoutIcon = false, isOnlyIcon = false,...rest }: ButtonProps) => {
    ...
    return (
        ...
        >
            {isOnlyIcon ? (
                ...
                <Typography className={`flex items-center gap-2 text-button justify-center ${rest.disabled ? 'opacity-30' : ''}`}>
